      ...
      <Box mt="3rem" textAlign="center">
        <Box boxShadow="xl">
          ...
          <Flex pl="2rem" pb="1rem" gap="12px">
            ...
            />
            <Link
              href={`https://twitter.com/intent/tweet?original_referer=https://githubwrapped.netlify.app&text=In 2022, I made over ${data?.totalCount} commits, was active ${data?.activeDaysCount}/365 days with longest streak of ${data?.longestStreak?.streak}days! Check your %23GithubWrapped %23GithubWrapped2022 👇&tw_p=tweetbutton&url=githubwrapped.netlify.app`}
              target="_blank"
            >
